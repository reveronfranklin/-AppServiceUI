...
export class CustomerListPage implements OnInit {
  ...
  codigoSeleccionado: string;
    ...
    ionViewDidEnter() {
        ...
        this.nombreUsuario='';
        if(this.usuario !== null && this.usuario.nombreUsuario!== null && this.usuario.nombreUsuario !== 'undefined'){
          this.nombreUsuario= '(' + this.usuario.user +'-' + this.usuario.nombreUsuario +')';
        }
        const filter = {
        ...
        this.clienteService.listDireccionesClientesPorUsuario(filter).subscribe(resp => {
    ...
    cotizar(item: MtrClienteDireccionDto) {
      ...
      //this.router.navigate(['/menu/cotizacion-edit'], { state: { item } });
      this.router.navigate(['/menu/cotizacion-edit'], { state: { itemCliente: item } });
    }
